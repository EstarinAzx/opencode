...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a link to your conversation",
  ...
  "Xethryon auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Xethryon auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Xethryon uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Xethryon from reading sensitive files",
  "Use {highlight}xethryon run{/highlight} for non-interactive scripting",
  "Use {highlight}xethryon --continue{/highlight} to resume the last session",
  "Use {highlight}xethryon run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}xethryon serve{/highlight} for headless API access",
  "Use {highlight}xethryon run --attach{/highlight} to connect to a running server",
  "Run {highlight}xethryon upgrade{/highlight} to update to the latest version",
  "Run {highlight}xethryon auth list{/highlight} to see all configured providers",
  "Run {highlight}xethryon agent create{/highlight} for guided agent creation",
  "Use {highlight}/xethryon{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}xethryon github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/xethryon fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}xethryon debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/opencode{/highlight} for containerized deployment",
  "Use {highlight}/connect{/highlight} with Xethryon Zen for curated, tested models",
