/**
 * Extract memories service prompts for Xethryon.
 * Ported from cc-leak/src/services/extractMemories/prompts.ts.
 *
 * Adapted: Replaced tool name constants with OpenCode tool IDs.
 * Stripped TEAMMEM feature gate — uses individual-only mode.
 */
...
/**
 * Shared opener for extract prompts.
 */
